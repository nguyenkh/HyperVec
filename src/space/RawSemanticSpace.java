...
public class RawSemanticSpace implements SemanticSpace{
    ...
    public double getDirection(String word1, String word2) {
        if (word2Index.containsKey(word1) && word2Index.containsKey(word2)) {
            int index1 = word2Index.get(word1);
            int index2 = word2Index.get(word2);
            SimpleMatrix vec1 = new SimpleMatrix(1, vectorSize, true, vectors[index1]);
            SimpleMatrix vec2 = new SimpleMatrix(1, vectorSize, true, vectors[index2]);
            return vec2.normF() / vec1.normF();
        } else {
            return 0;
        }
    }
